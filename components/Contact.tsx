                                ...
                                <div className="lg:w-1/2 md:w-2/3 mx-auto space-y-6">
                                    ...
                                    <div className='flex flex-col space-y-16 pb-8'>
                                        <div className="flex flex-row space-x-2">
                                            <LocationOnIcon sx={{ fontSize: 36 }} className="text-sky-300 dark:text-sky-600"/>
                                            <div className="flex flex-row items-end">
                                                <p className="sub-header-text !text-white">
                                                    Location:
                                                </p>
                                                <p className=" text-white pl-2 md:text-lg">
                                                    Vancouver, BC, Canada
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex flex-row space-x-2">
                                            <MailIcon sx={{ fontSize: 36 }} className="text-sky-300 dark:text-sky-600"/>
                                            <div className="flex flex-row items-end">
                                                <p className="sub-header-text !text-white">
                                                    Email:
                                                </p>
                                                <p className="text-white pl-2 md:text-lg pb-1">
